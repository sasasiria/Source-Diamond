...
\u2022 إضافة  البوت وحساب  المساعد  في الدردشة مع حقوق المشرف.
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons = [
            [
                InlineKeyboardButton("⌔ الاوامر", url="https://telegra.ph/Source-Diamond-07-16"),
                InlineKeyboardButton("⌔ الاعضاء", callback_data="users"),
            ],
            [
        ...
        buttons = [
            [
InlineKeyboardButton("➕ ضيفني لجروبك", url=f'https://t.me/{USERNAME}?startgroup=true'),
            ],
            [
